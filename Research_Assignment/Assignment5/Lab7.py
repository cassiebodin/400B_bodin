...
plt.hist2d(xD,yD, bins=550, norm=LogNorm(), cmap='magma')
...
density_contour(xD,yD,80,80,ax=ax,colors=['red','orange','yellow','blue','white'])
...
density_contour(rnew[:,0],rnew[:,2],80,80,ax=ax,colors=['red','orange','yellow','blue','white'])
...
density_contour(rnew[:,0],rnew[:,1],80,80,ax=ax,colors=['red','orange','yellow','blue','white'])
